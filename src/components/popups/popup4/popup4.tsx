...
export default function Popup4(props: PopupProps) {
    ...
    return (
        <Box className={classes.root}
            ...
            <Box display={"flex"} height={"100%"} flexDirection={"column"}>
                ...
                <Box p={2} height={!popupContext.isMobile ? "65%" : "unset"}>
                    <div className={classes.formParent}>
                        <form onSubmit={(e) => {
                            ...
                            <Grid container justifyContent="center" spacing={2}>
                                {!props.hideTitle && <Grid item sm={12}>
                                    <Typography
                                        onClick={(e) => {
                                            if (props.creationMode) {
                                                e.stopPropagation();
                                ...
                                {!props.hideBody && <Grid item sm={12}>
                                ...
                                <Grid item xs={12}>
                                    <Grid container spacing={2}>
                                        {!props.hideFirstTextFormField && <Grid item xs={12} onClick={(e: any) => {
                                            if (props.creationMode) {
                                                e.stopPropagation();
                                        ...
                                        {!props.hideSecondTextFormField && <Grid item xs={12} onClick={(e: any) => {
                                            if (props.creationMode) {
                                                e.stopPropagation();
                                                props.onFormInputSelected && props.onFormInputSelected();
                                            }
                                        ...
                                        <Grid item xs={12}>
                                            <div className={classes.positiveButtonWrapper}>
                                                <Button type="submit"
                                                        ...
                                                        className={classNames(classes.positiveButton, props.creationMode ? styles.creation_mode_button : "",)}>{props.submitting_form ?
